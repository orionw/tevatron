...
### if dl or msmarco_dev is in the name of the dataset, the new dataset name is after the - and use the tevatron msmarco-passages dataset
if [[ $dataset_name == *"dl"* ]] || [[ $dataset_name == *"msmarco-dev"* ]]; then
