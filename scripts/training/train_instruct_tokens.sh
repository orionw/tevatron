...
# bash scripts/training/train_instruct_tokens.sh tokens orionweller/joint-msmarco-passage-aug  "4,5,6,7" 0 > with_tokens.log 2>&1
...
deepspeed --include localhost:$3 --master_port "6000$4" --module tevatron.retriever.driver.train \
  ...
  --negatives_first_n 3 \
  --add_special_tokens_for_query_passage
  # --dont_shuffle
