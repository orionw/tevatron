...
deepspeed --include localhost:$3 --master_port "6000$4" --module tevatron.retriever.driver.train \
  ...
  #  was 200 warmup and 1 gradient accumulation
  # --dont_shuffle
# bash scripts/training/train_modernbert_eos.sh eos orionweller/joint-msmarco-passage-aug  "0,1,2,3,4,5,6,7" 0 > modernbert_eos.log 2>&1
# 
# 
# 